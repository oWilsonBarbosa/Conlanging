...
O vocalismo é de **uma vogal** (`/e/`) — uma qualidade e nenhuma duração: o
grau zero e as sonorantes silábicas fazem o resto. `[o]`, `[eː]`, `[a]`, `[i]`
e `[u]` não são fonemas — ver documento 02 §3.4 para de onde cada um vem.
